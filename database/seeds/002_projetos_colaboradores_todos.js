...
export default {
    ...
    up: async () => {
        ...
        await TodoModel.bulkCreate([
            { title: 'Revisar proposta de orçamento', id_colaborador: colaboradores[0].id },
            { title: 'Enviar relatório semanal', id_colaborador: colaboradores[0].id },
            { title: 'Atualizar perfil no sistema', id_colaborador: colaboradores[0].id },
            { title: 'Agendar reunião com cliente', id_colaborador: colaboradores[1].id },
            { title: 'Organizar arquivos da equipe', id_colaborador: colaboradores[1].id },
            { title: 'Registrar feedback do cliente', id_colaborador: colaboradores[2].id },
            { title: 'Cadastrar nova tarefa no CRM', id_colaborador: colaboradores[3].id },
            { title: 'Atualizar metas trimestrais', id_colaborador: colaboradores[4].id }
        ]);
    },
